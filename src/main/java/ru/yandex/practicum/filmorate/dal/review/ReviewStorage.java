...
@Repository
public class ReviewStorage extends BaseRepository<Review> {
    ...
    public ReviewStorage(JdbcTemplate jdbc, RowMapper<Review> mapper, ResultSetExtractor<List<Review>> listExtractor) {
